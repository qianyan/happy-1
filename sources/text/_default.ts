...
export const en = {
    ...
    connect: {
        ...
        serverConnectionFailed: ({ server }: { server: string }) => `Cannot connect to server: ${server}`,
        authenticationFailed: 'Authentication failed. The server rejected your credentials.',
    ...
    newSession: {
        ...
        noMachinesFound: 'No machines found for this account.',
        noMachinesFoundHelp: 'Make sure the CLI daemon is running on your computer with the same account.',
        noMachinesAccountInfo: ({ accountId }: { accountId: string }) => `Account: ${accountId}`,
        noMachinesTroubleshoot: 'Troubleshooting tips:',
        noMachinesTip1: '• Run `happy daemon start` on your computer',
        noMachinesTip2: '• Verify CLI is authenticated: `happy auth status`',
        noMachinesTip3: '• Ensure CLI and app use the same server',
        ...
        resumeSessionPlaceholder: 'Resume from session ID (optional)',
        sessionType: {
            title: 'Session Type',
            simple: 'Simple',
            worktree: 'Worktree',
    ...
    tools: {
        ...
        askUserQuestion: {
            ...
            other: 'Other',
            otherDescription: 'Provide a custom answer',
    ...
    settingsAccount: {
        ...
        name: 'Name',
        username: 'Username',
        usernameSubtitle: 'Tap to edit',
        usernameNotSet: 'Not set',
        editUsername: 'Edit Username',
        editUsernameDescription: 'Choose a unique username (3-30 characters, letters, numbers, underscore, dash)',
