...
export const ca: TranslationStructure = {
    ...
    connect: {
        ...
        serverConnectionFailed: ({ server }: { server: string }) => `No es pot connectar al servidor: ${server}`,
        authenticationFailed: 'Autenticació fallida. El servidor ha rebutjat les teves credencials.',
    ...
    newSession: {
        ...
        noMachinesFound: 'No s\'han trobat màquines per a aquest compte.',
        noMachinesFoundHelp: 'Assegura\'t que el daemon del CLI s\'estigui executant al teu ordinador amb el mateix compte.',
        noMachinesAccountInfo: ({ accountId }: { accountId: string }) => `Compte: ${accountId}`,
        noMachinesTroubleshoot: 'Consells per resoldre problemes:',
        noMachinesTip1: '• Executa `happy daemon start` al teu ordinador',
        noMachinesTip2: '• Verifica que el CLI estigui autenticat: `happy auth status`',
        noMachinesTip3: '• Assegura\'t que el CLI i l\'app utilitzin el mateix servidor',
    ...
    tools: {
        ...
        askUserQuestion: {
            ...
            other: 'Altre',
            otherDescription: 'Proporciona una resposta personalitzada',
    ...
    settingsAccount: {
        ...
        name: 'Nom',
        username: 'Nom d\'usuari',
        usernameSubtitle: 'Toca per editar',
        usernameNotSet: 'No establert',
        editUsername: 'Editar nom d\'usuari',
        editUsernameDescription: 'Tria un nom d\'usuari únic (3-30 caràcters, lletres, números, guió baix, guió)',
        usernamePlaceholder: 'el_teu_nom_usuari',
        usernameTaken: 'Aquest nom d\'usuari ja està en ús',
        usernameUpdated: 'Nom d\'usuari actualitzat',
        github: 'GitHub',
        tapToDisconnect: 'Toca per desconnectar',
        server: 'Servidor',
        connectionInfo: 'Informació de connexió',
        customServer: 'Servidor personalitzat',
        defaultServer: 'Servidor per defecte',
    ...
    markdown: {
        ...
        mermaidSyntaxError: 'Error de sintaxi al diagrama Mermaid',
