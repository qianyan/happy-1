...
export const pl: TranslationStructure = {
    ...
    newSession: {
        ...
        resumeSessionPlaceholder: 'Wznów z ID sesji (opcjonalnie)',
        sessionType: {
            title: 'Typ sesji',
            simple: 'Prosta',
            worktree: 'Worktree',
    ...
    commandPalette: {
        ...
        startRecording: 'Rozpocznij nagrywanie głosu',
        startRecordingSubtitle: 'Nagraj i transkrybuj swój głos',
        stopRecording: 'Zatrzymaj nagrywanie',
        stopRecordingSubtitle: 'Zatrzymaj nagrywanie i transkrybuj',
        toggleSidebarSubtitle: 'Pokaż lub ukryj panel boczny',
    },
    ...
    tools: {
        ...
        askUserQuestion: {
            ...
            other: 'Inne',
            otherDescription: 'Podaj własną odpowiedź',
    ...
    settingsVoice: {
        ...
        languageTitle: 'Język',
        languageDescription: 'Wybierz preferowany język dla transkrypcji głosowej. To ustawienie synchronizuje się na wszystkich Twoich urządzeniach.',
        preferredLanguage: 'Preferowany Język',
        preferredLanguageSubtitle: 'Język używany do transkrypcji głosowej',
        language: {
        ...
        openaiTitle: 'Transkrypcja Głosowa',
        openaiDescription: 'Użyj OpenAI Whisper do transkrypcji głosu na tekst. Dotknij przycisku mikrofonu i mów, aby dodać tekst do wiadomości.',
        openaiApiKey: 'Klucz API OpenAI',
        apiKey: 'Klucz API',
        openaiApiKeyPlaceholder: 'sk-xxxxx...',
        saveCredentials: 'Zapisz',
        credentialsSaved: 'Klucz API zapisany pomyślnie',
        apiKeyRequired: 'Proszę wprowadzić swój klucz API OpenAI',
        apiKeyConfigured: 'Klucz API skonfigurowany',
        apiKeyNotConfigured: 'Klucz API nie skonfigurowany',
        apiKeyCredentials: 'Konfiguracja Klucza API',
    ...
    machine: {
        ...
        searchByNameOrHostname: 'Szukaj po nazwie lub hoście',
        searchResults: 'Wyniki wyszukiwania',
        availableMachines: 'Dostępne maszyny',
        noMachinesMatchingSearch: ({ searchQuery }: { searchQuery: string }) => `Nie znaleziono maszyn pasujących do "${searchQuery}"`,
        daemon: 'Daemon',
        status: 'Status',
    ...
    keyboardShortcuts: {
        ...
        toggleVoiceRecording: 'Przełącz nagrywanie głosu',
        archiveSession: 'Zarchiwizuj sesję',
        deleteSession: 'Usuń sesję',
    },
