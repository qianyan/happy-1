...
export const pt: TranslationStructure = {
    ...
    connect: {
        ...
        serverConnectionFailed: ({ server }: { server: string }) => `Não foi possível conectar ao servidor: ${server}`,
        authenticationFailed: 'Falha na autenticação. O servidor rejeitou suas credenciais.',
    ...
    newSession: {
        ...
        noMachinesFound: 'Nenhuma máquina encontrada para esta conta.',
        noMachinesFoundHelp: 'Certifique-se de que o daemon do CLI está rodando no seu computador com a mesma conta.',
        noMachinesAccountInfo: ({ accountId }: { accountId: string }) => `Conta: ${accountId}`,
        noMachinesTroubleshoot: 'Dicas de solução de problemas:',
        noMachinesTip1: '• Execute `happy daemon start` no seu computador',
        noMachinesTip2: '• Verifique se o CLI está autenticado: `happy auth status`',
        noMachinesTip3: '• Certifique-se de que o CLI e o app usam o mesmo servidor',
    ...
    sessionInfo: {
        ...
        continueFromHereSubtitle: 'Iniciar uma nova sessão continuando esta conversa',
    ...
    tools: {
        ...
        askUserQuestion: {
            ...
            other: 'Outro',
            otherDescription: 'Forneça uma resposta personalizada',
    ...
    settingsVoice: {
        ...
        languageDescription: 'Escolha seu idioma preferido para transcrição de voz. Esta configuração sincroniza em todos os seus dispositivos.',
        preferredLanguage: 'Idioma Preferido',
        preferredLanguageSubtitle: 'Idioma usado para transcrição de voz',
        language: {
        ...
        openaiTitle: 'Transcrição de Voz',
        openaiDescription: 'Use o OpenAI Whisper para transcrever sua voz em texto. Toque no botão do microfone e fale para adicionar texto à sua mensagem.',
        openaiApiKey: 'Chave API do OpenAI',
        apiKey: 'Chave API',
        openaiApiKeyPlaceholder: 'sk-xxxxx...',
        saveCredentials: 'Salvar',
        credentialsSaved: 'Chave API salva com sucesso',
        apiKeyRequired: 'Por favor, insira sua chave API do OpenAI',
        apiKeyConfigured: 'Chave API configurada',
        apiKeyNotConfigured: 'Chave API não configurada',
        apiKeyCredentials: 'Configuração da Chave API',
    ...
    settingsAccount: {
        ...
        name: 'Nome',
        username: 'Nome de usuário',
        usernameSubtitle: 'Toque para editar',
        usernameNotSet: 'Não definido',
        editUsername: 'Editar nome de usuário',
        editUsernameDescription: 'Escolha um nome de usuário único (3-30 caracteres, letras, números, sublinhado, hífen)',
        usernamePlaceholder: 'seu_nome_usuario',
        ...
        cliLoginCommand: 'COMANDO DE LOGIN CLI (TOQUE PARA COPIAR)',
        cliLoginDescription: 'Execute este comando em qualquer terminal para fazer login na sua conta com o Happy CLI.',
        privacy: 'Privacidade',
